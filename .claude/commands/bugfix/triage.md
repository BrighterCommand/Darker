...
2. Determine the next bug id and a slug:
   ...
   - Format: `bugfixes/NNNN-{slug}/` (4-digit, e.g. `bugfixes/0001-fallback-async-exceptions/`)
...
query/handler/decorator is unstated, ask the user via `AskUserQuestion`, then fold the answers

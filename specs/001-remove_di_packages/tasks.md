...
- [x] **1. Remove SimpleInjector and LightInject project references from test projects**
...
- [x] **2. Remove integration test files for SimpleInjector and LightInject**
...
- [x] **3. Remove projects from solution files**
...
- [x] **6. Verify solution builds and all tests pass**
...
- [x] **9. Update agent instruction files**
...
- [x] **10. Update ADR 0004 to reflect removal**
...
- [x] **11. Update ADR 0003 if it references the removed packages**
  - Check `docs/adr/0003-fluent-builder-for-query-processor.md` for references
  - Update or remove as needed

### Phase 4: Final Verification

- [x] **12. Final build and test verification**
